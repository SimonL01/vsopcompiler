...
namespace Compilers
{
    Compiler::Compiler(string sourceFile) : lexAnalysis(make_unique<LexicalAnalyzer>(this->readFileToString(ABSOLUTE_PATH + sourceFile), sourceFile)), sourceFilePath(ABSOLUTE_PATH + sourceFile)
    {
    }
